...
print("  is that item identity resolves most of the coarse intake contrast --")
print("  central desk or not -- and much less of the fine one.  r13 quantifies")
...
print("  ticket and logging it accordingly, and (ii) the opening group being")
print("  an independent signal that happens to align.  The log records no")
print("  intervention and no counterfactual, so the question is not")
