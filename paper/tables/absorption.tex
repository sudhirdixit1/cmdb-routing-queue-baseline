...
\toprule
metric & b\_lo & b\_hi & V\_lo & V\_hi & D & D\_lo & D\_hi & R & R\_fieller\_lo & R\_fieller\_hi & fieller\_kind \\
\midrule
...
\caption{Absolute absorption $D$ first, the ratio $R$ second, with its Fieller set and the set's kind.}
