...
\biasNoisyBefore\ that did not exist. The two experiments above refuted every finite-sample explanation for that apparent
...
experiments that found that, and the check that guards it, are the subject of
this section.
