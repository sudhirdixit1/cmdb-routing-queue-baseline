...
The strands are set out below, each with what this paper takes
from it.
...
imperfection patterns of Suriadi et al.~\cite{suriadi2017imperfection} where they apply.
...
Weytjens and De Weerdt~\cite{weytjens2022leakage}. A log--target pair is excluded only for a
