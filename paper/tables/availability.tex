...
\begin{tabular}{>{\raggedright\arraybackslash}p{0.300\linewidth}r>{\raggedright\arraybackslash}p{0.440\linewidth}}
\toprule
...
\caption{What the interaction file establishes, and what it does not. Case study cohort, reassignment target.}
