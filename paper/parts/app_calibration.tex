...
in that same order; the difference is the \nLabelsLostToMinShare\
directional labels Table~\ref{tab:triple} withdraws. One of those is the only
...
it moves the resolution by more than the calibration would. What moves across all four is how much resolution
