...
separate role and Appendix~\ref{app:layers} uses it.
...
\item[Amendment 6 --- the topical pre-filter of the pilot frame was nulled.]
The frame's keyword filter was applied to titles and abstracts, which is a
filter on how a paper describes itself rather than on what it does. Its effect
on the estimates is reported in \texttt{results/s06\_frame.csv}.
\end{description}
...
register-quality mechanisms and their levels; the five confirmatory contrasts
and the Holm procedure; the two families over which simultaneous bands are
