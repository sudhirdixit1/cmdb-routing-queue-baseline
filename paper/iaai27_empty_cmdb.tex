...
criterion demands a gap of $3.396$ and the best pairs found reach $1.907$ and
$2.913$. That is a property of the tolerance and of the threshold axis's
scale, not evidence that those pairs are redundant, and we report the two
failures rather than retuning until twelve appear.
...
\paragraph{What replicates.} On every one of the three logs, \textbf{the
baseline choice alone moves $R$ by more than $R$ itself}: the spread is
$0.565$, $0.467$ and $0.654$ against reference values of $0.350$, $0.378$ and
$0.471$. The metric axis moves it by $0.301$, $0.337$ and $0.205$ --- smaller
than the baseline axis on all three, and still between four and nine tenths of
the effect being reported. This is the paper's central claim and it is no
longer an $n=1$ claim.
...
admitted by the registered rules and yields two scored pairs. On both,
...
once in every one of $43{,}809$ cases. Excluded pairs are reported with their
...
by reading; the suite carries $199$ mutations, each of which changes the
