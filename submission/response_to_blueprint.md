...
|---|---|---:|---|---|
| 1 | Introduction | 1,757 | 1,200–1,500 | just under |
| 2 | Related work | 560 | 1,200–1,500 | under |
| 3 | The specification surface | 1,282 | ~1,500 | ✓ |
| 4 | Estimation and inference | 3,347 | 2,000–2,500 | **over** |
| 5 | The registered benchmark design | 1,114 | 1,200–1,500 | ✓ |
| 6 | Multi-log results | 3,643 | 2,000–2,500 | **over** |
| 7 | Case study: a configuration management database | 1,836 | 1,500–2,000 | ✓ |
| 8 | Decision-analytic evaluation | 1,020 | — | added |
| 9 | Simulation against a known answer | 1,829 | 1,000–1,500 | just over |
| 10 | Threats to validity | 1,719 | 1,200–1,500 | **over** |
