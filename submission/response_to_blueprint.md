...
|---|---|---:|---|---|
| 1 | Introduction | 1,294 | 1,200–1,500 | ✓ |
| 2 | Related work | 992 | 1,200–1,500 | under |
| 3 | The specification surface | 1,956 | ~1,500 | ✓ |
| 4 | Estimation and inference | 3,344 | 2,000–2,500 | **over** |
| 5 | The registered benchmark design | 802 | 1,200–1,500 | under |
| 6 | Multi-log results | 3,392 | 2,000–2,500 | **over** |
| 7 | Case study: a configuration management database | 2,576 | 1,500–2,000 | just over |
| 8 | Decision-analytic evaluation | 1,616 | — | added |
| 9 | A reporting standard, and software | 644 | — | added |
| 10 | Simulation | 1,052 | 1,000–1,500 | just over |
| 11 | Limitations | 1,401 | 1,200–1,500 | just over |
